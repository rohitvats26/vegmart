...
import 'package:vegmart/screens/header.dart';
          ...
          slivers: [
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                    (_, index) => _buildProductItem(index),
                childCount: 20,
              ),
            ),
            //_buildPromoBanner(),
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned(right: 16, bottom: 0, child: Image.asset('assets/delivery_bike.png', height: 80, width: 100)),
          ],
        ),
      ),
    );
