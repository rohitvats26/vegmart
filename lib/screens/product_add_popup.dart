...
import 'package:vegmart/models/product_option.dart';
...
class __ProductPopupContentState extends State<_ProductPopupContent> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ProductOption> productOptions = [
      ...
      ProductOption(
        imagePath: 'assets/vegetables/orange.png',
        isBestValue: false,
        discount: '5% OFF',
        details: '75 g',
        combo: '2',
        unitPrice: '₹26.7/100 g',
        currentPrice: '₹40',
        originalPrice: '₹50',
      ),
      ProductOption(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: widget.isMobile ? 18 : 20, fontWeight: FontWeight.w600, color: const Color(0xFF212121)),
              ),
            ),
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () => {print('Add a product to cart')},
                        ),
                      ],
                    ),
                  ],
                    ...
                    Column(
                      ...
                      children: [
                        if (_itemCounts[index]! > 0)
                          _buildCounter(index, isMobile)
                        else
                          _buildAddButton(index, isMobile),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _buildCounter(int index, bool isMobile) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            icon: Icon(Icons.remove_rounded, size: isMobile ? 18 : 20, color: Color(0xFF2A9F75), weight: 1200),
            padding: EdgeInsets.zero,
            constraints: BoxConstraints(),
            onPressed: () {
              setState(() {
                if (_itemCounts[index]! > 0) {
                  _itemCounts[index] = _itemCounts[index]! - 1;
                }
              });
            },
          ),
          ...
          IconButton(
            icon: Icon(Icons.add_rounded, size: isMobile ? 18 : 20, color: Color(0xFF2A9F75), weight: 1200),
            padding: EdgeInsets.zero,
            constraints: BoxConstraints(),
            onPressed: () {
              setState(() {
